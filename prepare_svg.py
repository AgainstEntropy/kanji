...
if __name__ == "__main__":
    kanjidic2 = Path("./data/kanjidic2.xml")
    json_path = Path("./data/id_to_text.json")
    id_to_text = parse_kanjidic2(kanjidic2, save_path=json_path)

    original_dir = Path("./data/kanjivg-20230110-main")
    save_dir = Path("./data/kanjivg-20230110-main-wo-num")
